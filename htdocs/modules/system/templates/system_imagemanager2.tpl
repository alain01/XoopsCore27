...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" as="font" crossorigin="anonymous"  href="<{xoAppUrl url='media/font-awesome6/css/solid.min.css'}>">
    <link rel="stylesheet" type="text/css" media="screen" as="font" crossorigin="anonymous"  href="<{xoAppUrl url='media/font-awesome6/css/brands.min.css'}>">
    <link rel="stylesheet" type="text/css" media="screen" as="font" crossorigin="anonymous"  href="<{xoAppUrl url='media/font-awesome6/css/v4-shims.min.css'}>">
